...
![Merged PRs](https://img.shields.io/badge/Merged_PRs-7-fb8500?style=flat)
...
**fix** 14% · **docs** 14% · **ci** 14% · **other** 57% *(based on 7 merged PR titles)*

#### Ship log

- `2026-06-12` **[volcano-sh/website](https://github.com/volcano-sh/website)** — [website: restore Google Analytics 4 for volcano.sh](https://github.com/volcano-sh/website/pull/517)
- `2026-06-12` **[volcano-sh/volcano](https://github.com/volcano-sh/volcano)** — [ci: set read-only default GitHub Actions permissions](https://github.com/volcano-sh/volcano/pull/5369)
...
- **[volcano-sh/agentcube](https://github.com/volcano-sh/agentcube)** [![GitHub stars](https://img.shields.io/badge/stars-148-gold?style=flat)](https://github.com/volcano-sh/agentcube/stargazers) - [manifests: load REDIS_PASSWORD from Secret via secretKeyRef](https://github.com/volcano-sh/agentcube/pull/372)
