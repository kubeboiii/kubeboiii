...
![Merged PRs](https://img.shields.io/badge/Merged_PRs-5-fb8500?style=flat)
![Open PRs](https://img.shields.io/badge/Open_PRs-10-fb8500?style=flat)
![Repos](https://img.shields.io/badge/Repos-8-fb8500?style=flat)

#### Contributor mix

**fix** 20% · **docs** 20% · **other** 60% *(based on 5 merged PR titles)*

#### Ship log

- `2026-06-03` **[kagent-dev/website](https://github.com/kagent-dev/website)** — [fix(footer): update trademark link to LF Projects policies](https://github.com/kagent-dev/website/pull/378)
- `2026-06-03` **[volcano-sh/agentcube](https://github.com/volcano-sh/agentcube)** — [manifests: load REDIS_PASSWORD from Secret via secretKeyRef](https://github.com/volcano-sh/agentcube/pull/372)
- `2026-06-02` **[volcano-sh/website](https://github.com/volcano-sh/website)** — [Add favicon to Volcano website](https://github.com/volcano-sh/website/pull/508)
- `2026-06-02` **[volcano-sh/website](https://github.com/volcano-sh/website)** — [website: fix broken OG image and supporter links](https://github.com/volcano-sh/website/pull/510)
- `2026-05-19` **[pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws)** — [docs: replace Terraform lifecycle block with Pulumi ignoreChanges in …](https://github.com/pulumi/pulumi-aws/pull/6277)
...
- **[volcano-sh/volcano](https://github.com/volcano-sh/volcano)** [![GitHub stars](https://img.shields.io/badge/stars-5.6k-gold?style=flat)](https://github.com/volcano-sh/volcano/stargazers) - open: [metriccollect: use memory working set for agent eviction metrics](https://github.com/volcano-sh/volcano/pull/5337), open: [docs,ci: improve CLOMonitor contributing detection and workflow permissions](https://github.com/volcano-sh/volcano/pull/5369), open: [clomonitor: expose license scanning for CLOMonitor](https://github.com/volcano-sh/volcano/pull/5370), open: [docs: add Artifact Hub badge for CLOMonitor](https://github.com/volcano-sh/volcano/pull/5371)
...
- **[volcano-sh/agentcube](https://github.com/volcano-sh/agentcube)** [![GitHub stars](https://img.shields.io/badge/stars-145-gold?style=flat)](https://github.com/volcano-sh/agentcube/stargazers) - [manifests: load REDIS_PASSWORD from Secret via secretKeyRef](https://github.com/volcano-sh/agentcube/pull/372)
- **[volcano-sh/website](https://github.com/volcano-sh/website)** [![GitHub stars](https://img.shields.io/badge/stars-30-gold?style=flat)](https://github.com/volcano-sh/website/stargazers) - [website: fix broken OG image and supporter links](https://github.com/volcano-sh/website/pull/510), [Add favicon to Volcano website](https://github.com/volcano-sh/website/pull/508), open: [website: restore Google Analytics 4 for volcano.sh](https://github.com/volcano-sh/website/pull/517)
